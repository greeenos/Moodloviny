...
import { applyWithOptionalHover, fillSelectValue } from 'background/utils/form-actions';
...
function handleSelect(
  ...
  for (let i = 0; i < inputList.length; ++i) {
    ...
    applyWithOptionalHover({
      ...
      hoverTarget: currentSelect,
      apply: () => fillSelectValue(currentSelect, correctOption.value)
    });
  }
